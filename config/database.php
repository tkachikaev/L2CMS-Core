...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'l2forge'),
        ...
        'game' => [
            ...
            'username' => env('GAME_DB_USERNAME', 'l2forge'),
    ...
    'redis' => [
        ...
        'options' => ['cluster' => env('REDIS_CLUSTER', 'redis'), 'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'l2forge'), '_').'_database_')],
