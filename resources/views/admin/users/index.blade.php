...
<div class="users-summary">
    ...
    <div class="content-stat"><span>{{ __('Disabled') }}</span><strong>{{ $inactiveCount }}</strong></div>
    <div class="content-stat"><span>{{ __('Unverified') }}</span><strong>{{ $unverifiedCount }}</strong></div>
    <p>{{ __('This section manages CMS users only. It does not create or modify Login Server accounts.') }}</p>
</div>
